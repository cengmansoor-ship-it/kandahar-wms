...
const SYSTEM_ROLE_META: Record<string, { icon: string; colorClasses: string; namePs: string; nameDr: string; descPs: string; descDr: string }> = {
  ...
  [ROLES.WAREHOUSE_DIRECTOR]:   { icon: "🏭", colorClasses: "border-blue-300 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-700/50",    namePs: "اجناسو آمر",         nameDr: "آمر اجناس",          descPs: "ګدام نظارت",       descDr: "نظارت انبار" },
