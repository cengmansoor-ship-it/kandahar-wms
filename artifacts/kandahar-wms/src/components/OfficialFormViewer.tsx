    ...
    <div className="flex flex-col bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
      ...
      <div className="relative">
        ...
        <button
          onClick={handlePrint}
          dir="rtl"
          className="absolute bottom-5 left-5 z-20 flex items-center gap-2 px-5 py-3 bg-blue-600 text-white text-sm font-bold rounded-2xl shadow-xl hover:bg-blue-700 active:scale-95 transition-all select-none"
          title={pick("چاپ کول", "چاپ")}
        >
