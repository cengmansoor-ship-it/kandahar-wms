      ...
      <Router>
        ...
        <Routes>
          ...
          >
            ...
            <Route path="/inventory/checklist" element={<ProtectedRoute allowedRoles={[ROLES.SUPER_ADMIN, ROLES.WAREHOUSE_DIRECTOR]}><Suspense fallback={<PageLoader />}><ChecklistManagement /></Suspense></ProtectedRoute>} />
